class Admin::SandwichesController < ApplicationController
  # GET /sandwiches
  # GET /sandwiches.json
  def index
  ...
  def create
    ...
    respond_to do |format|
      if @sandwich.save
        format.html { redirect_to [:admin,@sandwich], notice: 'Sandwich was successfully created.' }
  ...
  def update
    ...
    respond_to do |format|
      if @sandwich.update_attributes(params[:sandwich])
        format.html { redirect_to [:admin,@sandwich], notice: 'Sandwich was successfully updated.' }
